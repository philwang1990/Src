...
namespace KKday.API.WMS.Models.Repository.Booking
{
    public class OrderRepository
    {
        ...
        public OrderKKdayModel setOrderModel(DataKKdayModel data)
        {
            OrderKKdayModel book = new OrderKKdayModel();
            ...
            book.eventBackupData = data.eventBackupData==null ?null : data.eventBackupData.Replace("-","");
        ...
        public omdlFlightInfo getFlightInfo2(DataKKdayModel data)
        {
        ...
        public omdlShuttleDate getShuttleInfo2(DataKKdayModel data) //接送 
        {
        ...
        public omdlRentCar getRendCar2(DataKKdayModel data) //租車
        {
        ...
        public omdlPsgrData getPsgData2(DataKKdayModel data)
        {
        ...
        public omdlSendData getSendData2(DataKKdayModel data)
        {
        ...
        public omdlOtherData getOtherData2(DataKKdayModel data)
        {
        ...
        public omdlContactData getContactData2(DataKKdayModel data)
        {
