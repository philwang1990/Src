...
namespace KKday.API.WMS.Models.Repository.Booking
{
    public static class DataSettingRepository
    {
        ...
        public static DataKKdayModel chkModules(DataKKdayModel data)
        {
        ...
        public static DataKKdayModel getDefaultDataModel(int qty) 
        {

            DataKKdayModel d = new DataKKdayModel();
