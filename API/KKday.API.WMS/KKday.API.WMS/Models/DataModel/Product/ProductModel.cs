...
namespace KKday.API.WMS.Models.DataModel.Product
{
    public class ProductModel
    {
        ...
        public string prod_no { get; set; }//商品編號 vv
        public string prod_name { get; set; }//商品名稱 vv
        public string prod_currency { get; set; }//商品進貨幣別
        public string prod_name_main_lang { get; set; }//商品主語系商品名稱
        public string prod_type { get; set; }//商品大分類 M01-M08 vv
        ...
        public string introduction { get; set; } //簡述
        ...
        public string policy_type { get; set; } //取消規則,1:不扣手續費，退全額（包含當天取消者）2：無法退費 3: 指定手續費
        ...
        public int days { get; set; } //產品所需時間(天) vv
        public int hours { get; set; } //產品所需時間(時) vv
        ...
        public string prod_img_url { get; set; }//商品主畫面圖片url
        ...
        public double ref_price { get; set; }//當時幣別最低成人售價(特價) vv B2D>>套價
        public double ref_sale_price { get; set; }//當時幣別最低成人售價(原價) vv B2D>>牌價



        public string order_email { get; set; }//訂單處理人email
        public string disease_note { get; set; }//疾病提醒注意事項
    ...
    public class Images
    {
        ...
        public string img_sort { get; set; }//順序
    ...
    public class ProdCommentInfo //vv
    {
    ...
    public class MeetingPoint
    {
        ...
        public string meeting { get; set; }//集合地點
        public string img_url { get; set; }//集合地圖片url
        public string img_kkday_url { get; set; }//集合地圖片url
    }
}
