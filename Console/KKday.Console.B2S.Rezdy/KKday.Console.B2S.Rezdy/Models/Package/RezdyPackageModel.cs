...
namespace KKday.Consoles.B2S.Rezdy.Models.Package
{
    ...
    public partial class RezdyPackageModel
    {
        public static RezdyPackageModel FromJson(string json) => JsonConvert.DeserializeObject<RezdyPackageModel>(json, KKday.Consoles.B2S.Rezdy.Models.Package.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this RezdyPackageModel self) => JsonConvert.SerializeObject(self, KKday.Consoles.B2S.Rezdy.Models.Package.Converter.Settings);
    }
