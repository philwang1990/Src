    ...
    public class PackageRepository
    {
        ...
        public void Main()
        {
            try
            {
                ...
                var get = CommonTool.GetDataNew("https://api.rezdy.com/latest/availability?apiKey=0b3d137cc1db4108a92c309fa7d7f6da&productCode=PVVRFE&startTimeLocal=2018-11-01 00:00:00&endTimeLocal=2019-12-31 00:00:00");
                //RezdyPackageModel

                var obj1 = RezdyPackageModel.FromJson(get.Result);
                Console.WriteLine(value: get.Result);
